...
.mt40{margin-top:30px;}
  ...
  <!--   <li id="items" style="width:1000px;display:none;margin-top:10px; margin-left:130px; width: 200px;height: 320px;border:solid 1px #ccc;padding: 10px;text-align:center;">
      ...
      <div class="caption">
        <h3>潮流动态</h3>
        <span>创建时间</span>
        <p><a href="<?php echo U('Home/Fashion/msg');?>" class="btn btn-primary" role="button">详情</a></p>
      </div>
    </li> -->
    <div id="ul">
    <ul></ul>
  ...
  var p = 1;//页码信息
  var isLoading = false;
  var url = "<?php echo U('Home/Fashion/ajaxfashion');?>";
    ...
    function requestFashion(){
     //加载请求是关门
      ...
      $.get(url,{p:p},function(data){
        ...
        //         <button style="color:#0ef;margin-left:50px;background-color:#f11;width:100px;height:40px;"><a href="<?php echo U('Home/Fashion/msg/id/+fid');?>" >详情</a></button>\n\ </li>');
