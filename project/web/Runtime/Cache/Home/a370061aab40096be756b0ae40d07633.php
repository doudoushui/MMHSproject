...
<div style="width:80%;margin:20px auto;height:800px;">
  <div style="width:250px;float:left">
     <div style="width:250px;height:50px;border:1px solid #ccc;line-height:50px"><span style="margin-left:10px;font-size:20px;color:#ccc">客户点评</span></div>
     <div style="width:250px;height:50px;border:1px solid #ccc;line-height:50px;margin-top:20px"><span style="margin-left:10px;font-size:20px"><a href="<?php echo U('Home/Feedback/add');?>" onclick="func()">填写反馈信息</a></span></div>
  ...
  <div style="width:800px;float:right;border:1px solid #ccc">
     <form action="<?php echo U('Home/Feedback/index');?>" method="get">
              ...
              <div style="float:right">
                <label>用户名:<input value="<?php echo ($_GET['keyword']); ?>" name="keyword" type="search" placeholder=""></label>
                <button type="submit" class="btn btn-info">查询</button>
              </div>
        </form>
     </div>
  <div style="width:800px;float:right;border:1px solid #ccc">
     <?php if(is_array($sugs)): foreach($sugs as $k=>$vo): ?><div style="width:700px;height:300px;margin:10px auto;border-bottom:1px solid #ccc">
        <div style="width:700px;height:40px;font-size:18px;margin-bottom:10px"><span>点评人:</span>&nbsp;&nbsp;<?php echo ($vo["username"]); ?></div>
        <div style="width:700px;height:40px;font-size:18px;margin-bottom:10px"><span>点评时间:</span>&nbsp;&nbsp;<?php echo ($vo["stime"]); ?></div>
        
        <div style="width:700px;height:200px;font-size:18px">
         <?php echo ($vo["smsg"]); ?>
        </div>
      </div><?php endforeach; endif; ?>
</div>
<div style="width:800px;border:1px solid #ccc;float:right">
  <style type="text/css">
