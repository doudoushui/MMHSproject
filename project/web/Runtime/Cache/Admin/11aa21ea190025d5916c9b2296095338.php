...
<body>
            ...
            <div class="dataTable_wrapper">
              <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                <div class="row">
                  ...
                  <form action="<?php echo U('Admin/Thinkauthrule/index');?>" method="get">
                  ...
                  <div class="col-sm-6">
                    <div id="dataTables-example_filter" class="dataTables_filter">
                      <label>权限规则名:<input value="<?php echo ($_GET['keyword']); ?>" name="keyword" type="search" class="form-control input-sm" placeholder="" aria-controls="dataTables-example"></label>
                    ...
                    <table id="dataTables-example" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dataTables-example_info">
                      <thead>
                        <tr role="row">
                          ...
                          <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 80px;" aria-label="Browser: activate to sort column ascending">权限路径[name]</th>

                          <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 100px;" aria-label="Browser: activate to sort column ascending">权限规则名[title]</th>
                       
                          <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 60px;" aria-label="Platform(s): activate to sort column ascending">类型[type]</th>
           
                          <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 98px;" aria-label="Engine version: activate to sort column ascending">状态[status]</th>
                          <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 100px;" aria-label="CSS grade: activate to sort column ascending">操作[opration]</th>
                        </tr>
                      </thead>
                      <tbody>
                        <?php if(is_array($rule)): foreach($rule as $k=>$vo): ?><tr class="gradeA odd" role="row">
                            ...
                            <td class="center"><?php echo ($vo["status"]); ?></td>
                              ...
                              <?php  if($_SESSION['adminname'] == 'admin'){ ?> 
                                ...
                                <a href="<?php echo U('Admin/Thinkauthrule/save',array('id'=>$vo['id']));?>" class="btn btn-primary " type="button"><i class="fa fa-list"></i></a>
                              </td>   
                             <?php  }else{ ?> 
                                  <td class="center">
                                  <button class="btn btn-danger btn-del" type="button" disabled="disabled"><i class="fa fa-times"></i></button>
                                  <button class="btn btn-primary " disabled="disabled"><i class="fa fa-list"></i></button>
  ...
  <script type="text/javascript">
    ...
    $('.btn-del').click(function(){
      ...
      var url = "<?php echo U('Admin/Thinkauthrule/ajaxdel');?>";
      // alert(url);
      var btn = $(this);
      //ajax
