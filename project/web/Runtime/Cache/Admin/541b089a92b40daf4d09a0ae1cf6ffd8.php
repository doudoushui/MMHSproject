            ...
            <div class="dataTable_wrapper">
              <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                <div class="row">
                  ...
                  <form action="<?php echo U('Admin/Fashion/index');?>" method="get">
                  ...
                  <div class="col-sm-6">
                    <div id="dataTables-example_filter" class="dataTables_filter">
                      <label>标题名称:<input value="<?php echo ($_GET['keyword']); ?>" name="keyword" type="search" class="form-control input-sm" placeholder="" aria-controls="dataTables-example"></label>
                    ...
                    <table id="dataTables-example" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dataTables-example_info">
                      <thead>
                        <tr role="row">
                          ...
                          <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 50px;" aria-label="Browser: activate to sort column ascending">图片</th>
                          <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 60px;" aria-label="Browser: activate to sort column ascending">标题名</th>
                          <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 60px;" aria-label="Platform(s): activate to sort column ascending">创建时间</th>                
                          <!-- <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 198px;" aria-label="Engine version: activate to sort column ascending">主要内容</th> -->
                      ...
                      <tbody>
                        <?php if(is_array($fashions)): foreach($fashions as $k=>$vo): ?><tr class="gradeA odd" role="row">
                            <td class="sorting_1 sid"><?php echo ($vo["id"]); ?></td>
                            <td class="sorting_1">
                              <img src="<?php echo ($vo["fpic"]); ?>" width="50px">
                            </td>
                            <td class="ftitle"><?php echo ($vo["title"]); ?></td>
                            <td><?php echo ($vo["ftime"]); ?></td>
                              <td class="center">
                                <button class="btn btn-danger btn-del " type="button"><i class="fa fa-times">&nbsp;删除</i></button>&nbsp;&nbsp;                              
                                <a href="<?php echo U('Admin/Fashion/save',array('id'=>$vo['id']));?>" class="btn btn-primary " type="button"><i class="fa fa-list">&nbsp;修改</i></a>
                              </td>
                            </tr>
                            <tr><th colspan="5"><center>主要内容</center></th></tr>
                            <tr>
                            <td class="ffmsg" colspan="5"><?php  echo htmlspecialchars_decode($vo['fmsg']); ?></td>
                           </tr>

                          <!--   <td class="ffmsg"><textarea></textarea></td>  --><?php endforeach; endif; ?>
                      </tbody>
                    </table>
 ...
 <script type="text/javascript" src="/Public/Admin/js/jquery-1.8.3.min.js"></script>
  <script type="text/javascript">
    ...
    $('.btn-del').click(function(){
      ...
      var url = "<?php echo U('Admin/Fashion/ajaxdel');?>";
      // alert(url);
      var btn = $(this);
      //ajax
    ...
    $('.ftitle').dblclick(function(){
      ...
      var v = $(this).html();
      // 创建inp
      var inp = $('<input type="text" value="'+v+'" title="ftitle" />')
    //将input插入td中
    $(this).html(inp);
    //让input处于选中状态
    inp.select();
    ...
    inp.blur(function(){
      ...
      //获取当前的id
      var id = $(this).parents('tr').find('.sid').html();
      var url = "<?php echo U('Admin/Fashion/ajaxedit');?>";

      //发送ajax
      $.post(url,{id:id,title:newV},function(data){
        if(data == 1){
          // alert('修改成功');
          td.html(newV);
        }else{
    ...
    //绑定双击事件
    // $('.ffmsg').dblclick(function(){
    //   //获取当前的文本
    //   var v = $(this).html();
    //   // 创建inp
    //   var inp = $('<input type="textarea" value="'+v+'" fmsg="ffmsg" />')
    // //将input插入td中
    // $(this).html(inp);
    // //让input处于选中状态
    // inp.select();
    ...
    //   //获取当前的id
    //   var id = $(this).parents('tr').find('.sid').html();
    //   var url = "<?php echo U('Admin/Fashion/ajaxeditmsg');?>";
