           ...
           <div class="row">
            ...
            <thead>
              <tr role="row">
                ...
                <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 129px;" aria-label="Browser: activate to sort column ascending">图片</th>
                <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 129px;" aria-label="Browser: activate to sort column ascending">商品名</th>
                <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 98px;" aria-label="Engine version: activate to sort column ascending">价格</th>
                <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 98px;" aria-label="Engine version: activate to sort column ascending">库存</th>
                <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 98px;" aria-label="Engine version: activate to sort column ascending">销量</th>
                <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 98px;" aria-label="Engine version: activate to sort column ascending">状态</th>
                <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 98px;" aria-label="Engine version: activate to sort column ascending">热销否</th>
                <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 98px;" aria-label="Engine version: activate to sort column ascending">新品否</th>
                <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 98px;" aria-label="Engine version: activate to sort column ascending">点赞量</th>
                <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 98px;" aria-label="Engine version: activate to sort column ascending">描述</th>
            ...
            <tbody>
              <?php if(is_array($goodss)): foreach($goodss as $k=>$vo): ?><tr class="gradeA odd" role="row">
                  ...
                  <td class="sorting_1">
                    <img src="<?php echo ($vo["pic"]); ?>" width="50px">
                  </td>
                  ...
                  <!-- <td class="center"><?php echo ($vo["hobby"]); ?></td> -->
                  <td class="center">
                    ...
                    <a href="<?php echo U('Admin/Goods/save',array('id'=>$vo['id']));?>" class="btn btn-primary btn-primary" type="button"><i class="fa fa-wrench"></i> 修改</a><br>
                     <a href="<?php echo U('Admin/Goods/save',array('id'=>$vo['id']));?>" class="btn btn-primary btn-info" type="button"><i class="fa fa-camera"></i> 上图</a>
                  </td>
  ...
  <script type="text/javascript">
   ...
   $('.edit').dblclick(function(){
    ...
    inp.blur(function(){
      ...
      //发送ajax
      $.get(url,{id:id,gname:newV},function(data){
        if(data == 1){
          // alert('修改成功');
          td.html(newV);
        }else{
   ...
   $('.edit_msg').dblclick(function(){
    ...
    inp.blur(function(){
      ...
      var url = "<?php echo U('Admin/Goods/ajaxedit');?>";
      //发送ajax
      $.get(url,{id:id,msg:newV},function(data){
        if(data == 1){
          // alert('修改成功');
          td.html(newV);
        }else{
