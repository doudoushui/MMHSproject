...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">潮流动态信息添加</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <div class="row">
      <div class="col-lg-12">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
               <div class="row">
                   <div class="col-lg-6">
                       <form role="form" action="<?php echo U('Admin/Fashion/insert');?>" method="post" enctype="multipart/form-data">
                       <input type="hidden" name="ftime">
                       <input type="hidden" name="id" value="<?php echo ($info["id"]); ?>">
                           
                           <div class="form-group">
                               <label>标题名</label>
                               <input name="title" placeholder="请输入要潮流动态标题" class="form-control">
                           </div>
                      ...
                      <!--      <div class="form-group">
                               <label>主要内容</label>
                               <textarea name="fmsg" rows="3" placeholder="请输入相关内容" class="form-control"></textarea>
                           </div> -->
