...
<body>
            ...
            <div class="dataTable_wrapper">
              <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                <div class="row">
                  ...
                  <form action="<?php echo U('Admin/Joke/index');?>" method="get">
                  ...
                  <div class="col-sm-6">
                    <div id="dataTables-example_filter" class="dataTables_filter">
                      <label>新闻标题:<input value="<?php echo ($_GET['keyword']); ?>" name="keyword" type="search" class="form-control input-sm" placeholder="" aria-controls="dataTables-example"></label>
                    ...
                    <table id="dataTables-example" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dataTables-example_info">
                      ...
                      <tbody>
                        <?php if(is_array($users)): foreach($users as $k=>$vo): ?><tr class="gradeA odd" role="row">
                            ...
                            <td class="center"><?php echo ($vo["joke_time"]); ?></td>
                            <td class="center">
  ...
  <script type="text/javascript">
    ...
    $('.btn-del').click(function(){
      ...
      var url = "<?php echo U('Admin/Joke/ajaxdel');?>";
      // alert(url);
      var btn = $(this);
      //ajax
