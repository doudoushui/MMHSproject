                       ...
                       <div class="col-lg-6">
                           <form role="form" action="<?php echo U('Admin/User/update');?>" method="post" enctype="multipart/form-data">
                               ...
                               <div class="form-group">
                                   <label>用户名</label>
                                   <input value="<?php echo ($info["username"]); ?>" name="username" placeholder="请输入4~10位数字,字母,下划线" class="form-control">
                               </div>
                               <div class="form-group">
                                   <label>密码</label>
                                   <input value="<?php echo ($info["pwd"]); ?>" type="password" name="pwd" placeholder="请输入4-10位数字,字母,下划线" class="form-control">
                               </div>
                               <div class="form-group">
                                   <label>邮箱</label>
                                   <input value="<?php echo ($info["email"]); ?>" type="text" name="email" placeholder="请输入合法邮箱账号" class="form-control">
                               </div>

                               <div class="form-group">
                                   <label>联系方式</label>
                                   <input value="<?php echo ($info["tel"]); ?>" type="text" name="tel" placeholder="请输入合法联系方式" class="form-control">
                               </div>

                               <div class="form-group">
                                   <label>上传头像</label>
                                   <input name="pic" type="file">
                                   <img src="<?php echo ($info["pic"]); ?>" width="100px">
                               </div>
                               ...
                               <div class="form-group">
                                   ...
                                   <label class="checkbox-inline">
                                       <input name="hobby[]" <?php if(in_array('0',$hobby) ): ?>checked<?php endif; ?> value="0" type="checkbox">篮球
                                   </label>
                                   <label class="checkbox-inline">
                                       <input name="hobby[]" <?php if(in_array('1',$hobby) ): ?>checked<?php endif; ?> value="1" type="checkbox">足球
                                   </label>
                                   <label class="checkbox-inline">
                                       <input name="hobby[]" <?php if(in_array('2',$hobby) ): ?>checked<?php endif; ?> value="2" type="checkbox">球球
                                   </label>
                               </div>
                               ...
                               <div class="form-group">
                                   ...
                                   <label class="radio-inline">
                                       <input type="radio" checked="" <?php if($info['sex'] == 1): ?>checked<?php endif; ?> value="1" id="optionsRadiosInline1" name="sex">男
                                   </label>
                                   <label class="radio-inline">
                                       <input type="radio" value="0" <?php if($info['sex'] == 0): ?>checked<?php endif; ?> id="optionsRadiosInline2" name="sex">女
                                   </label>
                                   <label class="radio-inline">
                                       <input type="radio" value="2" <?php if($info['sex'] == 2): ?>checked<?php endif; ?> id="optionsRadiosInline3" name="sex">保密
                                   </label>
                               </div>
