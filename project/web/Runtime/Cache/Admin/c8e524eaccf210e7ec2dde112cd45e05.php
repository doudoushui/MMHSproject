...
<body>
                    ...
                    <table id="dataTables-example" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dataTables-example_info">
                      <thead>
                        <tr role="row">
                          ...
                          <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 80px;" aria-label="Browser: activate to sort column ascending">用户名</th>
                          <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 50px;" aria-label="Platform(s): activate to sort column ascending">性别</th>
                          ...
                          <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 80px;" aria-label="Platform(s): activate to sort column ascending">email</th>
                          <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 98px;" aria-label="Engine version: activate to sort column ascending">爱好</th>
                      ...
                      <tbody>
                        ...
                        <?php if(is_array($users)): foreach($users as $k=>$vo): ?><tr class="gradeA odd" role="row">
                            ...
                            <td class="uname"><?php echo ($vo["username"]); ?></td>
                            ...
                            <td class="center">
                              ...
                              <a href="<?php echo U('Admin/User/save',array('id'=>$vo['id']));?>" class="btn btn-primary " type="button"><i class="fa fa-list"></i></a>
                            </td>
  ...
  <script type="text/javascript">
    ...
    $('.uname').dblclick(function(){
      ...
      var v = $(this).html();
      // 创建inp
      var inp = $('<input type="text" value="'+v+'" username="uname" />')
    //将input插入td中
    $(this).html(inp);
    //让input处于选中状态
    inp.select();
    ...
    inp.blur(function(){
      ...
      //获取当前的id
      var id = $(this).parents('tr').find('.sid').html();
      var url = "<?php echo U('Admin/User/ajaxedit');?>";
