...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">潮流动态信息修改</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <div class="row">
      <div class="col-lg-12">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
               <div class="row">
                   <div class="col-lg-6">
                       <form role="form" action="<?php echo U('Admin/Fashion/update');?>" method="post" enctype="multipart/form-data">
                           ...
                           <div class="form-group">
                               <label>标题名</label>
                               <input name="title" value="<?php echo ($info["title"]); ?>" placeholder="请输入要潮流动态标题名称" class="form-control">
                           </div>

                           <div class="form-group">
                               <label>上传图片</label>
                               <input name="fpic" type="file">
                               <img src="<?php echo ($info["fpic"]); ?>" width="100px">
                           </div>

                            <div class="form-group">
                               <label>动态内容</label>
                            <!--    <textarea name="fmsg" rows="3" value="<?php echo ($info["fmsg"]); ?>" placeholder="请输入相关内容" class="form-control"><?php echo ($info["fmsg"]); ?></textarea> -->

                            <script id="editor" name="fmsg" type="text/plain" style="width:800px;height:500px;">
                              <?php echo ($info["fmsg"]); ?>
                            </script>
                           </div>
