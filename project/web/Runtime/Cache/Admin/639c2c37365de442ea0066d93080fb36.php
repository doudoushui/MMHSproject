                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <div id="dataTables-example_filter" class="dataTables_filter">
                      <label>管理员名:<input value="<?php echo ($_GET['keyword']); ?>" name="keyword" type="search" class="form-control input-sm" placeholder="" aria-controls="dataTables-example"></label>
                    ...
                    <table id="dataTables-example" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dataTables-example_info">
                      <thead>
                        <tr role="row">
                          ...
                          <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 80px;" aria-label="Browser: activate to sort column ascending">头像</th>

                          <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 80px;" aria-label="Browser: activate to sort column ascending">管理员名</th>
                       
                          <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 50px;" aria-label="Platform(s): activate to sort column ascending">联系方式</th>
           
                          <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 98px;" aria-label="Engine version: activate to sort column ascending">等级</th>

                          <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 98px;" aria-label="Engine version: activate to sort column ascending">权限规则</th>
                      ...
                      <tbody>
                        <?php if(is_array($double)): foreach($double as $k=>$vo): ?><tr class="gradeA odd" role="row">
                            ...
                            <td class="uname"><?php echo ($vo["adminname"]); ?></td>
                            <td class="center"><?php echo ($vo["tel"]); ?></td>
    
                            <td>
                              <?php if(($vo["permission"] == 1) ): ?>超级管理员                                                 
                                <?php else: ?> 
                                普通管理员<?php endif; ?>
                            </td>
                            <td class="center"><?php echo ($vo["group_id"]); ?></td>
                         <?php
 if(($_SESSION['adminname']) == 'admin'){ if($vo['adminname'] == 'admin'){ ?>
                         <td class="center">
                        <button class="btn btn-danger btn-del" type="button" disabled="disabled"><i class="fa fa-times"></i></button>  <!-- 删除失效 -->
                           <a href="<?php echo U('Admin/Adminuser/save',array('id'=>$vo['id']));?>" class="btn btn-primary " type="button"><i class="fa fa-list"></i></a>  <!-- 可编辑 -->
                       
                       </td>
                       <?php  }else{ ?>
                       <td class="center">
                       <button class="btn btn-danger btn-del" type="button"><i class="fa fa-times"></i></button>  <!-- 可删 -->
                       <a href="<?php echo U('Admin/Adminuser/save',array('id'=>$vo['id']));?>" class="btn btn-primary " type="button"><i class="fa fa-list"></i></a>  <!-- 编辑开启 -->
                        </td>
                        <?php  }}else{ if(($_SESSION['adminname']) == ($vo['adminname']) ){ ?> 
                   ...
                   <?php  }else{ ?>
                     <td class="center">
                     <button class="btn btn-danger btn-del" type="button" disabled="disabled"><i class="fa fa-times"></i></button>  <!-- 删除失效 -->
                     <a href="<?php echo U('Admin/Adminuser/save',array('id'=>$vo['id']));?>" class="btn btn-primary " type="button" disabled="disabled"><i class="fa fa-list"></i></a> <!-- 不可编辑 -->                    
                   </td>
                   <?php  } } ?>
  ...
  <script type="text/javascript">
    ...
    $('.btn-del').click(function(){
      ...
      var url = "<?php echo U('Admin/Adminuser/ajaxdel');?>";
      // alert(url);
      var btn = $(this);
      //ajax
