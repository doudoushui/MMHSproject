       ...
       <div class="col-lg-12">
           <div class="panel panel-default">
               ...
               <div class="panel-body">
                   <div class="row">
                       <div class="col-lg-6">
                           <form role="form" action="<?php echo U('Admin/Adminuser/update');?>" method="post" enctype="multipart/form-data">
                               <input type="hidden" name="id" value="<?php echo ($info["id"]); ?>">
                               <div class="form-group">
                                   <label>管理员名</label>
                                   <input value="<?php echo ($info["adminname"]); ?>" name="adminname" placeholder="请输入6~18位数字,字母,下划线" class="form-control">
                               </div>
                               <div class="form-group">
                                   <label>密码</label>
                                   <input value="<?php echo ($info["pwd"]); ?>" type="password" name="pwd" placeholder="请输入6~18位数字,字母,下划线" class="form-control">
                               </div>
                               ...
                               <div class="form-group">
                                   ...
                                   <label class="radio-inline">
                                       <input type="radio" checked="" <?php if($info['permission'] == 1): ?>checked<?php endif; ?> value="1" id="optionsRadiosInline1" name="permission">超级管理员
                                   </label>
                                   <label class="radio-inline">
                                       <input type="radio"  <?php if($info['permission'] == 2): ?>checked<?php endif; ?> value="2" id="optionsRadiosInline2" name="permission">普通管理员
                                   </label>
                               ...
                               <div class="form-group">
                                   ...
                                   <label class="checkbox-inline">
                                       <input name="groupid[]" <?php if(in_array('1',$group_id) ): ?>checked<?php endif; ?> value="1" type="checkbox">用户增删改查组
                                   </label>
                                   <label class="checkbox-inline">
                                       <input name="groupid[]" <?php if(in_array('2',$group_id) ): ?>checked<?php endif; ?> value="2" type="checkbox">管理员删改查组
                                   </label>
                                   <label class="checkbox-inline">
                                       <input name="groupid[]" <?php if(in_array('3',$group_id) ): ?>checked<?php endif; ?> value="3" type="checkbox">big  boss
                                   </label>
