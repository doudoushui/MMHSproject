                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <div id="dataTables-example_filter" class="dataTables_filter">
                      <label>岗位名称:<input value="<?php echo ($_GET['keyword']); ?>" name="keyword" type="search" class="form-control input-sm" placeholder="" aria-controls="dataTables-example"></label>
                ...
                <div class="row">
                  ...
                  <!-- 用户列表遍历 -->
                    <table id="dataTables-example" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dataTables-example_info">
                      ...
                      <tbody>
                        <?php if(is_array($jobs)): foreach($jobs as $k=>$vo): ?><tr class="gradeA odd" role="row">
                            <td class="sorting_1 sid"><?php echo ($vo["id"]); ?></td>
                            <td><?php echo ($vo["work"]); ?></td>
                            <td><?php echo ($vo["personnum"]); ?></td>
                            <td><?php echo ($vo["job_phone"]); ?></td>
                            <td><?php echo ($vo["job_email"]); ?></td>
                            <td><?php echo ($vo["job_intro"]); ?></td>
                            <td><?php echo ($vo["job_address"]); ?></td>
                            <td class="center">
                              <button class="btn btn-danger btn-del " type="button"><i class="fa fa-times"></i></button>&nbsp;&nbsp;                              
                              <a href="<?php echo U('Admin/Job/save',array('id'=>$vo['id']));?>" class="btn btn-primary " type="button"><i class="fa fa-list"></i></a>
                            </td>
 ...
 <script type="text/javascript" src="/Public/Admin/js/jquery-1.8.3.min.js"></script>
  <script type="text/javascript">
    ...
    $('.btn-del').click(function(){
      ...
      var url = "<?php echo U('Admin/Job/ajaxdel');?>";
      // alert(url);
      var btn = $(this);
      //ajax
