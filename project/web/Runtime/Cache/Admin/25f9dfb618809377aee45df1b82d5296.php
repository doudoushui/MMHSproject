                     ...
                     <div class="col-lg-6">
                         <form role="form" action="<?php echo U('Admin/User/insert');?>" method="post" enctype="multipart/form-data">
                             ...
                             <div class="form-group">
                                 <label>用户名</label>
                                 <input name="username" placeholder="请输入4~10位数字,字母,下划线" class="form-control">
                             </div>
                             <div class="form-group">
                                 <label>密码</label>
                                 <input type="password" name="pwd" placeholder="请输入4~10位数字,字母,下划线" class="form-control">
                             </div>
                             <div class="form-group">
                                 <label>邮箱</label>
                                 <input type="text" name="email" placeholder="请输入合法邮箱账号" class="form-control">
                             </div>
                             ...
                             <div class="form-group">
                                 ...
                                 <label class="checkbox-inline">
                                     <input name="hobby[]" value="0" type="checkbox">篮球
                                 </label>
                                 <label class="checkbox-inline">
                                     <input name="hobby[]" value="1" type="checkbox">足球
                                 </label>
                                 <label class="checkbox-inline">
                                     <input name="hobby[]" value="2" type="checkbox">球球
                                 </label>
                             </div>
