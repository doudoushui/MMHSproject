...
<body>
  <?php  var_dump($_SESSION); $AUTH = new \Think\Auth(); var_dump($AUTH->getGroups(session('adminid'))); $aaa = $AUTH->getGroups(session('adminid')); ?>
    <div id="wrapper">
                        ...
                        <li>
                           <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> 用户管理<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                               <?php  $AUTH = new \Think\Auth(); if($AUTH->check('Admin/User/index', session('adminid'))){ ?>
                                  <li>
            ...
            <div class="col-lg-6">
              <form role="form" action="<?php echo U('Admin/Joke/update');?>" method="post" enctype="multipart/form-data">
                <input type="hidden" name="id" value="<?php echo ($info["id"]); ?>">
                  ...
                  <div class="form-group">
                      <label>乐闻内容</label>
                      <textarea name="intro" rows="3" class="form-control"><?php echo ($info["joke_msg"]); ?></textarea>
                    </div>
